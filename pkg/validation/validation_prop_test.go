...
func TestValidateString(t *testing.T) {
	...
	err = PropValidate(prop, "verylongstringvalue")
...
func TestValidateInt(t *testing.T) {
	...
	// Валидное значение
	err := PropValidate(prop, 25)
	if err != nil {
		t.Errorf("ожидалось, что ошибка не вернётся, но получили: %s", err)
	}

	// Слишком маленькое значение
	err = PropValidate(prop, 5)
...
func TestValidateFloat(t *testing.T) {
	...
	// Валидное значение
	err := PropValidate(prop, 50.5)
	if err != nil {
		t.Errorf("ожидалось, что ошибка не вернётся, но получили: %s", err)
	}

	// Слишком маленькое значение
	err = PropValidate(prop, -1.0)
...
func TestValidateSelect(t *testing.T) {
	...
	// Валидное значение
	err := PropValidate(prop, "opt1")
	if err != nil {
		t.Errorf("ожидалось, что ошибка не вернётся, но получили: %s", err)
	}

	// Некорректное значение
	err = PropValidate(prop, "invalid")
